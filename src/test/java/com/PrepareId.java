...
public final class PrepareId {

	private int PrepareId_size = 0;
	...
	private void set_time(java.lang.Long value_1) {
		PrepareId_size += time_TagEncodeSize;
		int size_1 = 0;

		size_1 += Serializer.computeVarInt64Size(value_1);
		PrepareId_size += size_1;
		this.time = value_1;
	}
	...
	private void set_id(java.lang.Integer value_1) {
		PrepareId_size += id_TagEncodeSize;
		int size_1 = 0;
	...
	public static PrepareId decode(ByteBuf buf) {
		PrepareId value_1 = new PrepareId();
		...
		value_1.PrepareId_size = buf.readerIndex() - f_Index;
		return value_1;
	}
	...
	public static PrepareId decode(ByteBuf buf, int length_1) {
		...
		value_1.PrepareId_size = length_1;
		value_1.verify();
		return value_1;
	}

	public int getByteSize() {
		return this.PrepareId_size;
	}

	public static PrepareIdBuild newBuilder() {
		return new PrepareIdBuild();
	}
	...
	public static class PrepareIdBuild {
		private java.lang.Long time;
		private java.lang.Integer id;

		public PrepareIdBuild setTime(java.lang.Long a) {
			this.time = a;
			return this;
		}
		...
		public PrepareIdBuild clearTime() {
			this.time = null;
			return this;
		}
		...
		public PrepareIdBuild setId(java.lang.Integer a) {
			this.id = a;
			return this;
		}
		...
		public PrepareIdBuild clear() {
			this.time = null;
			this.id = null;
			return this;
		}

		private PrepareIdBuild() {
		}
	}
